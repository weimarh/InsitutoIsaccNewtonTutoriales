...
using InsitutoIsaccNewtonTutoriales.Data;
using InsitutoIsaccNewtonTutoriales.Entities;
using InsitutoIsaccNewtonTutoriales.Extensions;

namespace InsitutoIsaccNewtonTutoriales.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class CategoryItemController : Controller
    {
        ...
        {
            //Lista de items de la categoria, extraidas de la base de datos. Se usa el filtro
        ...
        {
            //Pasamos los tipos de media a la vista
            List<MediaType> mediaTypes = await _context.MediaType.ToListAsync();

            //Esto es para el dropdown box
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            //recuperamos una lista de todos los itms de la categoria
            ...
            //Nos da las opciones en el dropbox
            categoryItem.MediaTypes = mediaTypes.ConvertToSelectList(categoryItem.MediaTypeId);
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,CategoryId,MediaTypeId,DateTimeItemReleased")] CategoryItem categoryItem)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // hay que poner el 2do elemento sino no aparece
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
            // hay que poner el 2do argumento, sino no aparece. pasamos un objeto para el categoryid que esta relacionado con el categoryitem
            return RedirectToAction(nameof(Index), new { categoryId = categoryItem.CategoryId});
        }
